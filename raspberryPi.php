...
<head>
    ...
    <title>SPARK Raspberry Pi Community</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 d-none d-lg-block ">
                        <img src="images/raspberry-pi-1.jpg" class="img-fluid align-items-center h-100 rounded-3" alt>
                    </div>
        ...
        <section class="team rounded-3  mb-3">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-3">
                        <div class="product-thumb h-100 shadow-sm">
                            <a href="Projects/handGuesture.php" class="product-title-link">
                                <div class="product-info d-flex text-center">
                                    <div class="w-100">
                                        <h5 class="product-title mb-0">
                        ...
                        <div class="row h-100">
                            ...
                            <div class="col-lg-4 col-12 h-auto">
                                <div class="product-thumb h-auto">
                                    <a href="#">
                                        <img src="images/Picture7.png" class="img-fluid product-image" alt="">
                                    </a>
                            ...
                            <div class="col-lg-4 col-12 h-auto">
                                <div class="product-thumb h-auto">
                                    <a href="#">
                                        <img src="images/Picture8.png" class="img-fluid product-image" alt="">
                                    </a>
                            ...
                            <div class="col-lg-4 col-12 h-auto">
                                <div class="product-thumb h-auto">
                                    <a href="#">
                                        <img src="images/Picture9.png" class="img-fluid product-image" alt="">
                                    </a>
                ...
                <div class="row team">
                    ...
                    <div class="col-12">
                        <div class="row h-100">
                            ...
                            <div class="col-lg-4 offset-lg-2 col-12 h-auto">
                                <div class="product-thumb h-auto">
                                    <a href="#">
                                        <img src="images/Picture10.png" class="img-fluid product-image" alt="">
                                    </a>
                                    ...
                                    <div class="product-info d-flex">
                                        <div>
                                            ...
                                            <p class="lead text-justify">Pi-Mora 2.2 took place in December 2022; With the
                                                ...
                                                in both the lecture and workshops sessions. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-12 h-auto">
                                <div class="product-thumb h-auto">
                                    <a href="#">
                                        <img src="images/Picture11.png" class="img-fluid product-image" alt="">
                                    </a>
