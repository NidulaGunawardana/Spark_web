...
<body>
    ...
    <main>
            ...
            <div class="container sticky-top mt-3 mb-3">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-light" href="communityFb.php">Community Facebook Page</a>
                        </li>
        ...
        <section class="slick-slideshow mt-0">
            <div class="slick-custom vh-100">
                <img src="images/slider 2.jpg" class="img-fluid h-100" alt="">

                <div class="slick-bottom mt-5 mt-lg-0">
                    <div class="container mt-lg-0 mt-md-4 mt-10">
                        <div class="row">
                            <div class="col-lg-8 col-10 offset-lg-2 offset-1 text-center">
                                ...
                                <p class="mt-lg-3 mb-lg-5 text-center fw-lighter" style="color: rgb(191, 191, 191);"><b>SPARK</b> will expose <b>ENTC</b> undergraduates to a set
                                    ...
                                    to be effective leaders and consummate professionals in the modern day industry.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="px-lg-5 px-0 py-5 py-lg-0 ">
                            ...
                            <div class="col-12">
                                <div class="tab-content" id="nav-tabContent">
                                            ...
                                            <div class="container px-2">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row">
                                                            ...
                                                            <p class="mb-3 text-secondary">
                                                                ...
                                                                After a rigorous assessment the following teams have shown outstanding competence in their
                                                                proposed solutions:
                                                            </p>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-12 text-justify">
                                                        <div class="row h-100">
                                                            <div class="col-12 my-auto">
                                                                <img src="images/spch22.4.png" alt="coral pic" class="img-fluid w-100 ">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-12 text-justify my-auto">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-12 text-justify my-auto">
                                                        <p class="lead mb-3 text-secondary my-auto">During the recent past, high prevalence of chronic
                                                            ...
                                                            and urine image sample to identify chronic kidney disease. We will use collected data of urine conductivity and
                                                            image samples of certain no of people and train a machine learning model to predict CKD and then predict result for new patient</p>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 text-justify my-auto">
                                                        <p class="lead mb-3 text-secondary my-auto">The Spark Challenge 2022/23 was an extension of the
                                                            ...
                                                            pinnacle at the Finale of the Spark Challenge 2022/23 which was successfully held on the 11th of
                                                            June 2023. Out of the fifteen teams who participated in the challenge, three teams emerged victorious.</p>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 text-justify my-auto">
                                                        <p class="lead mb-3 text-secondary my-auto"> Pest Sense offers a solution to this issue by constantly checking
                                                            ...
                                                            the advice made specifically for them. Hope this product will help farmers
                                                            all around the world to have better harvests which will definitely compensate for their invaluable efforts.</p>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-12 text-justify my-auto">
                                                        <p class="lead mb-3 text-secondary my-auto">This project is similarly centred on agricultural
                                                            ...
                                                            waste, and environmental harm. By offering advice to farmers via our solution, Cultiwave,
                                                            a mobile app and monitoring system, seeks to lessen these problems. It can provide
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-12 text-justify my-auto">
                                                        <p class="lead mb-3 text-secondary my-auto">This group has focused on Energy Generation, a topic that is
                                                            ...
                                                            in a more sustainable world. Their initiative centres on a paradigm shift in energy production. They were
                                    ...
                                    <div class="tab-pane fade" id="list-202" role="tabpanel" aria-labelledby="list-messages-list">
                                        <section class="team rounded-3 mb-5">
                                            <div class="container-lg">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="text-justify ">
                                                            <h2 class="mb-2 mt-5 text-center"><span>SPARK</span> Challenge Celebrations – 202..</h2>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-5">
                                                    <div class="col-12">
                                                        <div class="text-center">
                                                            ...
                                                            <p class="lead mb-3 fs-4 text-secondary"><b><i>Comming Soon...</i></b></p>
